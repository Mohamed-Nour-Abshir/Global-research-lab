            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    <div class="d-flex align-items-center justify-content-center text-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        ...
                        <i><img src="{{asset('assets/img/uk.png')}}" class="img-fluid" alt=""></i>
                    </div>
                    <h3 class="mb-3">Study in UK</h3>
                    <p class="mb-0">Home to some of the world’s greatest cities, the United Kingdom offers world-class education with a diverse and flexible range of courses. Besides, it is one of the most popular cultural hubs of Europe with a rich history to be proud of.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    <div class="d-flex align-items-center justify-content-center text-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        ...
                        <i><img src="{{asset('assets/img/canada.png')}}" class="img-fluid rounded-circle" alt="" ></i>
                    </div>
                    <h3 class="mb-3">Study in Canada</h3>
                    <p class="mb-0">Academic excellence, affordability and adventure – Canada stands out as an ideal place to study. It hosts more than 250,000 international students and has experienced a huge increase in demand from overseas students in recent years.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    <div class="d-flex align-items-center justify-content-center text-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        ...
                        <i><img src="{{asset('assets/img/usa.png')}}" class="img-fluid rounded-circle" alt="" ></i>
                    </div>
                    <h3 class="mb-3">Study in USA</h3>
                    <p class="mb-0">The US is home to the highest number of international students in the world. With famous cities, epic landscapes, high-ranked universities and vibrant exciting campus life, studying in the US offers the perfect blend of educational quality.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    <div class="d-flex align-items-center justify-content-center bg-primary text-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        ...
                        <i><img src="{{asset('assets/img/australia.png')}}" class="img-fluid rounded-circle" alt="" ></i>
                    </div>
                    <h3 class="mb-3">Study in Australia</h3>
                    <p class="mb-0">Whether you choose to undertake an MBA, engineering degree, humanities or English language course, Australia is difficult to beat in terms of standard of living, academic excellence, and support for international students.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    <div class="d-flex align-items-center justify-content-center bg-primary text-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        ...
                        <i><img src="{{asset('assets/img/germany.png')}}" class="img-fluid rounded-circle" alt="" ></i>
                    </div>
                    <h3 class="mb-3">Study in Germany</h3>
                    <p class="mb-0">We Offer Degree Programs for International Students. Without English Language Proficiency Required. Come and Join Hundreds of Students from All Over the World In Berlin, Germany. Apply Now.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    <div class="d-flex align-items-center justify-content-center bg-primary text-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        ...
                        <i><img src="{{asset('assets/img/sweden.png')}}" class="img-fluid rounded-circle" alt="" ></i>
                    </div>
                    <h3 class="mb-3">Study in Sweden</h3>
                    <p class="mb-0">Almost 40 universities are located in Sweden, many of which make it into top ranks globally, such as Uppsala University, Lund University or Stockholm University. Sweden has been one of the European pioneers for switching to English-language tuition and offers a whopping 900 degrees to choose from.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="{{asset('assets/img/testimonial-1.jpg')}}" alt="">
                            <div class="ps-4">
                                <h3>Client Name</h3>
                    ...
                    <div class="testimonial-item">
                        <p class="fs-4 fw-normal mb-4"><i class="fa fa-quote-left text-primary me-3"></i>Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat dolor rebum sit ipsum.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="{{asset('assets/img/testimonial-2.jpg')}}" alt="">
                            <div class="ps-4">
                                <h3>Client Name</h3>
                                <span class="text-uppercase">Profession</span>
                            </div>
